...
<head>
    ...
    <title>Wow Foods · Telugu Restaurant</title>
...
<body>
        ...
        <div class="container header-inner">
            <div style="display:flex;align-items:center;gap:12px;">
                ...
                <a class="brand" href="#">
                    ...
                    <span>Wow<span class="accent">Foods</span></span>
                </a>
            </div>
    ...
    <main>
        ...
        <section class="hero" aria-label="Hero">
            <div class="container">
                <div class="badge"><i class="fas fa-sparkles"></i> Authentic Telugu Flavors</div>
                <h1>Welcome to <br>Wow Foods</h1>
                <p>Authentic Telugu cuisine made with love. Spicy, flavorful, and unforgettable.</p>
                <div class="actions">
            ...
            <div class="container">
                <div class="section-header">
                    <div class="title-group">
                        ...
                        <p>Signature Telugu dishes, curated for you</p>
                    </div>
